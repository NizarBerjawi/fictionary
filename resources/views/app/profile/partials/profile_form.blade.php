...
<form action={{ $action }} method="POST" enctype="multipart/form-data">
    ...
    <div class="form-row">
        <div class="col mb-3">
            <input type="file" class="{{ className(['filepond'], [$errors->has('photo') ? 'is-invalid' : null]) }}" id="photo" name="photo" aria-describedby="uploadHelp">
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="col mb-3">
            <input type="hidden" name="username-validation-route" value="{{ route('profile.username') }}" disabled="disabled"/>
